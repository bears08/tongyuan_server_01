...
<script type="text/javascript"
	src="<%=root%>/js/exmanager/purchse_order_status_fix.js?p=<%=System.currentTimeMillis()%>"></script>
				...
				<div class="customerSearch h40" style="width: 98%">
					<table width="100%" border="0" cellspacing="0" cellpadding="10">
						...
						<tr height="30px;" align="right">
							...
							<td colspan="4"><input id="queryBtn" name="button"
		...
		<div id="change_order_status_dialog" class="easyui-dialog"
			...
			<p align="center">
				订单状态&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;<select id="orderStatus">
					...
					<option value="CASHSUCCESS">收银成功</option>
					<option value="CASHFAIL">收银失败</option>
					<option value="RETURNSUCCESS">退款成功</option>
					<option value="RETURNFAIL">退款失败</option>
				</select>
			</p>
		</div>
